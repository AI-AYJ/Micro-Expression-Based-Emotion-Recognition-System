...
from data_apex import CASME2Dataset
...
def main():
    ...
    image_root = './data/ApexImages_noOthersFear'
    ...
    # 학습
    model, _ = train(model, train_dataset, val_dataset, epochs, batch_size, learning_rate)
    ...
    # 테스트
    test_loss, test_accuracy = test(model, val_dataset, batch_size)
