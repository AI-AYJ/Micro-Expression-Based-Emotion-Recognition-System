...
## 📚 참고문헌
1. Zhang, S. et al. (2023). *MFVAN: Multi-scale fusion visual attention network for facial micro-expression recognition*. [DOI](https://doi.org/10.3389/fnins.2023.1216181)  
2. Yu, Y. et al. (2024). *Micro-expression recognition with transferable dual-stream spatiotemporal feature learning*. [arXiv](https://doi.org/10.48550/arXiv.2406.17538)  
3. Yan, W.-J. et al. (2014). *CASME II: An Improved Spontaneous Micro-Expression Database and the Baseline Evaluation*. [PLoS ONE](https://doi.org/10.1371/journal.pone.0086041)
